...
void DisPlay()//开机动画
{
	...
	printf("                                     int          p[]={1024,688,2736\n");
	printf("                               #define  r      k[j=(j+1)&32767]\n");
	printf("        ,2737,10930,     11184,16304,112209,16305,12210,16306\n");
	printf("      ,32688    ,32689,32690,20443,20443,20443},o[2000],\n");
	printf("    *q ,     n[    2000],f[2162],s,d=1,w,a=20,b=60,far\n");
	printf("  * x=       (int far*)0xb8000000L;unsigned i ,j;\n");
	printf("char    *t;unsigned char k[32768];void cdecl\n");
	printf(" main    ( )  {for(i=w=s=0;i<2000;++ i)o\n");
	printf("[           i]=x[i];for(i=0;i<32768; )\n");
	printf(" k            [i++]=(unsigned char)(63&  rand());         q=p+     1;t=   (char\n");
	printf(" *           )&n[+992];while (!kbhit(     )){for(i      =0;i<162    ;i+=   1)f\n");
	printf(" [             2000+i]=r+s;f[2000 +       a]=   255    ;i=    f[b   +2000  ]=0\n");
	printf("  ;    if(    r&1)a++;else a+=79          ;if    (r&  1)b      =b+  1;else b+=\n");
	printf("  79;a1=80;b %=80;w=(w+1)&3  ;              if(    !w)  {;s      +=d  ;if (!s||s\n");
	printf("   >191)d=-d;}for(i=0;2000  >             i;)    f[i  ++]      =((  f[i  +80]*\n");
	printf("     16 +f[i+160]*14+f[   i+              161    ]+f  [i+      162  ]))   >>5;\n");
	printf("       for(i=0;i<2000;)n[i                ++]   =(f    [i]    &15   >r&    15)\n");
	printf("           ?p[f[i]>>4                     ]:q[f[i]      >>4];*t=    68;    t[4\n");
	printf("                                          ]=79;t[8        ]=78     ;t[16  ]=89;\n\n");
	printf("t[20]=65;t[24]=78;t[28]=71;while(inp(986)&8);while(!(inp(986)&8));for(i=0;2000\n");
	milli_delay(10000);
	///////////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////////
	clear();
	...
	printf("                         ,r[26],                 far*s=\n");
	printf("                        (int far*               )(184L<<\n");
	printf("                        24),i,j,k;              volatile\n");
	printf("                        long far*p              =(+(long\n");
	printf("                        far*)(64L               <<16|108H\n");
	printf("                         ));void                ma1n(int\n");
	printf("                          a,int  b,int c){k=s[o[ a]];s[\n");
	printf("                           o[a]]=s[o[b]];s[o[b]]=k;if(\n");
	printf("                        !(++x%c)&&(k&255)-32){while(q==*p)\n");
	printf("                     ;q=*p;}}void Main(int a,int b,int c){if\n");
	printf("                   (a<(l/2))Main(a*2,b-2,c);do{for(i=c   =0;\n");
	printf("                  i<l-a;i++){    if((s[o[i]]&255)<(s[o    [i +a]        ]&255\n");
	printf("                 ))ma1n(i,i+  (c  =a),b);}}while(!!c);}  void  main(\n");
	printf("      int a,int b,int c){if(a    >0){for(i=l=0;i<2000;i++){r[(79+\n");
	printf("              i)/80]=l;if((s[i]&255)!=68&&(s[i]&255)!=79&&(s[i]&255)!=78)\n");
	printf("         o[l++]=i;}r[25]=l;main(-1,24,1);Main(1,24,-1);}else if(!a)\n");
	printf("   {if(c>  b){a=s[o[b]]&255;    i      =         b      ;     j=c;while(i<=j\n");
	printf("          ){while(i<c&&(s[o[i   ]      ]         &      +    255)<a)i\n");
	printf("      ++;while(j>b&&(255&s[o[j  ]      ]         )      >  a)j--;if(-i\n");
	printf("  >=-j  ){ma1n(i,j,8);i++;j--;}}main   (         0    ,b,j);main(0,i,c);\n");
	printf("       /*1999*/}}else{if(a>-25)main(a-1,0,0);main(0,r[25+a],r[26+a]-1);}}\n");
