...
OBJS		= kernel/kernel.o kernel/syscall.o kernel/start.o kernel/main.o\
			...
			lib/klib.o lib/klibc.o lib/string.o kernel/printf.o kernel/getcommand.o
...
# Write "boot.bin" & "loader.bin" into floppy image "MCINIX.IMG"
# We assume that "MCINIX.IMG" exists in current folder
buildimg :
	mount MCINIX.IMG /mnt/floppy -o loop
...
kernel/getcommand.o :  kernel/getcommand.c include/type.h include/const.h include/protect.h include/string.h include/proc.h \
			include/tty.h include/console.h include/global.h include/keyboard.h include/proto.h
	$(CC) $(CFLAGS) -o $@ $<
